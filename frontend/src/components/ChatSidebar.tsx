...
const ChatSidebar = ({sidebarOpen,setShowAllUsers,setSidebarOpen,showAllUsers,
  ...
  return (
   ...
   bg-gray-900 border-r border-gray-700 transform ${
                            ...
                            >
                                <div className='flex items-center gap-3'>
                                    ...
                                    <div className='flex-1 min-w-0'>
                                            ...
                                            {
                                                latestMessage && <div className="flex items-enter gap-2">
                                                    { isSentByMe ? <CornerUpLeft size={14}className='text-blue-400
                                                    text-shrink-0'/>:
       ...
       <div className="p-4 border-t border-gray-700 space-y-2">
        ...
        <button onClick={handleLogout} className='w-full flex items-center gap-3
        px-4 py-3 rounded-lg hover:bg-red-600 transition-colors text-red-500 hover:text-white '>
